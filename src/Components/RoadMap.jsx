...
export default function RoadMap() {
    return (
        <>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-7 child:py-5 child:text-gray-100 child:flex child:rounded-2xl'>
                {/* box */}
