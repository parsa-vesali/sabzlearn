        ...
        <>
            <div className='relative z-40'>
                ...
                <div className={`absolute shadow-lg bg-white dark:bg-dark-700 space-y-2 top-16 left-0 w-72 py-3 px-4 text-zinc-700 dark:text-gray-100 rounded-xl border-t-4 border-t-green-500 transition-all delay-75 ${isShowBox ? 'visible opacity-100' : 'invisible opacity-0'} child:transition-colors flex items-start flex-col`}>
                    ...
                    <div className='flex w-full flex-col gap-y-1 child-hover:bg-green-600  child-hover:text-gray-100 child:transition-all border-b border-b-neutral-200 dark:border-b-white/5 pb-4'>
                        <a href="#" className='flex items-center gap-x-2 py-2 rounded-lg px-2'>
                            <HomeOutlinedIcon />
                            پیشخوان
                        </a>
                        <a href="#" className='flex items-center gap-x-2 py-2 rounded-lg px-2'>
                    ...
                    <div className="flex w-full flex-col gap-y-1 child-hover:bg-red-600 child-hover:text-gray-100 child:transition-all">
                        <a href="#" className='flex items-center gap-x-2 py-2 rounded-lg px-2 '>
            ...
            {/* OVERLAY */}
            {isShowBox && (
                <div onClick={clickHandler} className='fixed w-full h-full top-0 left-0 bg-black/40 z-10 md:backdrop-blur transition-all show'></div>
            )}
        </>
    );
}
