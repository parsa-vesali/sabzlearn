...
export default function NavBar() {
    return (
        <div className='container shadow-lg bg-white dark:bg-dark-700 py-6 flex items-center justify-between'>
            ...
            <div className="flex items-center justify-center gap-x-8">
                ...
                {/* MENU */}
                <ul className=' text-lg child:dark:text-gray-100 child-hover:text-green-500 child:transition-all flex items-center justify-center gap-x-4'>
                    {
            ...
            <div className="flex items-center justify-center gap-x-4">
                ...
                {/* SEARCH BAR */}
                <div className="relative bg-gray-200 dark:bg-dark-500 py-3 px-4   rounded-full overflow-hidden text-slate-500  dark:text-gray-100 ">
